...
## Load normalized Illumina expression data for DRG

load('../data/Normalized_data_DRG.rda')
...
save(normExpr,targets,file="../output/ENSG_Normalized_data_DRG.rda")
...
pdf("../output/PCA_DRG.pdf",height=20,width=24)
...
pdf("../output/PCA_DRG_Combat.pdf",height=20,width=24)
...
save(datExpr.Combat,targets,file="../output/CombatCorrected_DRG.rda")
...
load('../output/CombatCorrected_DRG.rda')
...
save(normExpr.reg,targets,file="../output/Regressed_data_DRG.rda")


library(WGCNA)
pdf("../output/PCA_DRG_RegressionRIN.pdf",height=20,width=24)
